...
- Custom agents: `.github/agents/frontend.agent.md`, `.github/agents/testing.agent.md`
- Task prompts (via slash command): `.github/prompts/` (create-component, create-feature, review-pr)
